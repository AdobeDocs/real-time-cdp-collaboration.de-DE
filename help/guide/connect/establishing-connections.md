...
Wählen Sie dann **[!UICONTROL Verbindung mit Einladungscode herstellen]** aus.
...
| Feld | Beschreibung |
|-------|-------------|
| Firma | Der Firmenname des Mitarbeiters. |
| Name | Der vollständige Name der Person, die Sie einladen. |
| E-Mail-Adresse | Die E-Mail-Adresse, die der Mitarbeiter verwendet, um auf Real-Time CDP Collaboration [!DNL Starter] zuzugreifen. |
| Titel | Die Stellenbezeichnung des Hauptkontakts. |
...
![Der Arbeitsbereich „Verbinden“ mit dem Pluszeichen und der hervorgehobenen Option „Mitarbeiter einladen“.](/help/assets/connect/establish-connection/invite-collaborator/invite-collaborator.png){zoomable="yes"}

Das **[!UICONTROL Invite a Collaborator]** wird angezeigt, in dem Sie aufgefordert werden, die Informationen des eingeladenen Collaborators einzugeben. Füllen Sie die erforderlichen Felder für [!UICONTROL Firmenname], [!UICONTROL Vorname], [!UICONTROL Nachname] und [!UICONTROL E-Mail] aus.
